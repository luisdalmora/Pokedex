...
export default function RegionsPage() {
  return (
    <div className="space-y-12 pb-20">
      <PageHeader 
        title="Regiões do Mundo"
        subtitle="Do continente de Kanto às vastas terras de Paldea, cada região guarda seus próprios segredos, lendas e ecossistemas únicos."
        pill="Exploração Global"
      />
